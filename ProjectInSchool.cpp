...
struct HandleData {
    ...
    void findGroups() {
            ...
            for (const auto& group : listOfGroup) {
                ...
                for (const auto& submission : group->submissions) {
                    if (submission->statement == stateLate) {
                        late = true;
                    }
                    else if (submission->statement == stateNotSubmit) {
                        incomplete = true;
                    }
                }
            ...
            if (!incompleteFound) {
                std::cout << "All groups have completed or submitted on time.\n";
            }
        }
...
int main()
{
    ...
    while (true) {
        ...
        std::cout << "(6) Project status of group\n";
        std::cout << "Enter your option: ";
